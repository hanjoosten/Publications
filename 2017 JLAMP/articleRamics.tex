...
\label{sct:Reflection}
	...
	This paper shows how a computer can derive certain steps,
	helping the programmer to invent code an providing mathematical assurance of correctness (compliance-by-design).

	The analysis in this paper shows once more that inventing algorithms is far from trivial.
	...
	In practice we experience that programming in relation algebra yields an unconventional way of programming.
